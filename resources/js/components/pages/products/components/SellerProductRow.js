    ...
    >
            ...
            <Row style={{ flexDirection: "column", height: "100%" }}>
                <Col>
                    <Row>
                        ...
                        <Tag
                            style={{ margin: "4px" }}
                            color={
                                props.item.category.active ? "error" : "success"
                            }
                        >
                            {props.item.category.active
                ...
                <Row>
                    <Col style={{ marginRight: "15px" }}>
                        {props.intl.formatMessage({
                            id: "models.product.quantityInStock"
                        })}
                        :{" "}
                        <strong>
                            {unitsFormat(
                                props.item,
                                props.item.quantity_in_stock,
                                props.intl
                            )}
                        </strong>
                    </Col>
        ...
        <Col>
            ...
            >
                <Col>
                    <Tooltip
                        title={props.intl.formatMessage({ id: "crud.edit" })}
                    >
                        <Button
                            type={"primary"}
                            style={{ margin: "4px" }}
                ...
                <Col>
                    <Tooltip
                        title={props.intl.formatMessage({ id: "crud.delete" })}
                    >
                        <Button
                            type={"primary"}
                            style={{ margin: "4px" }}
                            ...
                            icon={<DeleteFilled />}
                            onClick={() => {
                                props.onDeleteClickCallback(props.item);
                            }}
                        />
                    </Tooltip>
                </Col>
